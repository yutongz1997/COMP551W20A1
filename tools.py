...
def gaussian_pdf(x: float, mean: float, var: float):
    """
...
def split_dataset(dataset, split_ratio=0.8):
    ...
    :param dataset: dataset in which its last column are labels
...
def evaluate_acc(y, y_pred):
    ...
    :return: model accuracy in [0..1] (= number of correct predictions / number of labels)
    """
